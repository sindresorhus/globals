...
interface GlobalsAmd {
	readonly 'define': false;
	readonly 'require': false;
}

interface GlobalsMocha {
...
interface GlobalsJquery {
	readonly '$': false;
	readonly 'jQuery': false;
}

interface GlobalsYui {
...
interface GlobalsServiceworker {
	readonly 'addEventListener': false;
	readonly 'applicationCache': false;
	readonly 'atob': false;
	readonly 'Blob': false;
...
interface GlobalsSharednodebrowser {
	readonly 'AbortController': false;
	readonly 'AbortSignal': false;
	readonly 'atob': false;
	readonly 'Blob': false;
...
interface GlobalsWebextensions {
	readonly 'browser': false;
	readonly 'chrome': false;
	readonly 'opr': false;
}

interface GlobalsGreasemonkey {
